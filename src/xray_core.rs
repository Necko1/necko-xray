pub mod app {
    ...
    pub mod version {
        tonic::include_proto!("xray.app.version");
    }
}
...
pub mod core {
    ...
    pub mod observatory {
        ...
        /// https://xtls.github.io/en/config/observatory.html#burstobservatoryobject
        pub mod burst {
...
pub mod transport {
    pub mod internet {
        ...
        /// https://xtls.github.io/en/config/transport.html#realityobject
        pub mod reality {
